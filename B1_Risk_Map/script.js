/* B1 final script — bilingual (bn/en), A2 localStorage integration, A3 weather, A4 ETCL
   FIXED: toBanglaNumber mapping + DOM safeguards + farmer marker restored
*/
...
async function loadAndRender(force=false){
  ...
  const center = DISTRICT_CENTERS[centerKey] || DISTRICT_CENTERS[DEFAULT_DISTRICT];

  if(!map) initMap(center);
  else if(force) map.setView(center,10);
